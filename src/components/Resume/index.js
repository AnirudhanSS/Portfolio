      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <p class="mb-4 text-base font-normal  text-gray-400">
              ...
              overview of cloud concepts, core services, security,
              architecture, pricing, and support.
            </p>
            <a
              href="https://coursera.org/verify/LWGPRPMZ7ET9"
              target="_blank"
              rel="noreferrer"
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            LPU - Object Oriented Programming using Java - Internship
            </h3>
            ...
            <a
              href="https://app.e-box.co.in/course/downloadCourseCompletionCertificate?code=ac5030e7-a4db-4ff2-ac66-f53b704e3013"
              target="_blank"
              rel="noreferrer"
          ...
          <li data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.freecodecamp.org/certification/Anirudhan/front-end-development-libraries"
              class="inline-flex items-center px-4 py-2 mt-5 text-sm font-medium border rounded-lg focus:z-10 focus:ring-4 focus:outline-none focus:text-blue-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700"
            >
              <svg
                class="w-4 h-4 mr-2"
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"SQL"} percent={55} />
            <BarGraph name={"Unity Engine"} percent={70} />
          </div>

          <a
            href={require("../../assets/files/Anirudhan's Resume.pdf")}
            download={"Anirudhan's Resume"}
