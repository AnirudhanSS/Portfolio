      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3
            ...
            data-aos={"fade-left"}
          >
            I'm <span className="text-yellow-600">Anirudhan</span>, a Web
            Enthusiast
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            I love playing music, reading comics and playing games. I have
            pursued BTech in Computer Science from Lovely Professional University. I am {getDate()}{" "}
          ...
          <p
            ...
            data-aos={"fade-right"}
          >
            I am currently looking for jobs. I have worked as a freelancer web developer and a game developer.
            I worked on reactJs, NextJs, TypeScript, Unity Engine and many more. I am
